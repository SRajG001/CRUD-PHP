                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><button type="button" id="edit" class="btn btn-warning mr-3" data-toggle="modal"
                                    data-target="#exampleModal" data-id="<?php echo $row['id'] ?>"
                                    data-value="<?php echo $row['task'] ?>">Edit</button><button type="button"
                                    id="delete" class="btn btn-danger" data-id="<?php echo $row['id']?>">Delete</button>
                            </td>
                        </tr>
                        <?php } ?>
                    </tbody>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="editForm" action="service.php" method="POST">
                        <div class="row">
                            <div class="col-md-10">
                                <input type="text" class="form-control" name="task" id="task"
                                    placeholder="Add text here...">
                                <input type="number" name="id" id="taskId" hidden>
                            </div>
                            <input class="btn btn-primary" type="submit" value="Submit">
                        </div>
                    </form>
